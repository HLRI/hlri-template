...
function custom_render_associated_floorplans() {
    ...
    if ( $associated_property ) {
        ...
        if ( $floorplans ) {
            echo '<style>.rightDf{float: right;display: inline-block;}.flIl{padding-left:10px;border: 1px solid rebeccapurple;padding: 10px;border-radius: 5px;background-color: #f2e5ff;font-size: 16px;}</style><div class="inside">';
            echo '<ul>';
            foreach ( $floorplans as $floorplan ) {
