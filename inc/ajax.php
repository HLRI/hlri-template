...
function test_get_developers_with_alternative_keywords() {
    ...
    if (isset($_GET['test_get_developers'])) {
        // Get alternative keywords for developer with known ID (replace 591 with the actual post ID)
        $developer_id = 591; // Example ID, replace with the actual post ID
        $alternative_keywords = get_post_meta($developer_id, 'alternative_keywords', true);
