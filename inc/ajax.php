        ...
        while ($peroperties->have_posts()) {
            ...
            $result2[] = [
                ...
                'metadata' => [
                    ...
                    'opt-min-price' => get_post_meta(get_the_ID(), 'hlr_framework_mapdata', true)['opt-price-min'],
                    ...
                    'opt-max-price' => get_post_meta(get_the_ID(), 'hlr_framework_mapdata', true)['opt-price-max'],
...
//                        }, $mapMetaType);
                             ...
                             $mapdata[] = [
                                 ...
                                 //                  'permalink' => get_the_permalink(),
                                 'permalink' => 'https://condoy.com/properties/' . $slug,
        ...
        set_transient($cache_key, $mapdata, 180 * MINUTE_IN_SECONDS);
    } else {
