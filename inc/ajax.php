...
//    }
    ...
    wp_send_json_success( $floor_plan_types );
}
...
function enqueue_dynamic_floor_plan_script() {
    wp_enqueue_script('dynamic-floor-plan-script', get_template_directory_uri() . '/assets/js/dynamic-floor-plan6.js', array(), null, true);
