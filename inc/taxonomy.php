...
<!--                $('#sales-teamchecklist').before('<div style="height: 45px;"><input type="text" id="live-search" placeholder="Search..." style="margin-top: 20px;width: 100%;"></div>');-->
<!---->
...
function add_search_input_to_meta_box($meta_box_id) {
    ...
    if ($pagenow === 'post.php' && isset($_GET['post']) && get_post_type($_GET['post']) === 'properties') {
        ...
        <script>
            jQuery(document).ready(function($) {
                // Add the search input element before the specified meta box checklist
