...
<form action="" method="post">
    <div class="wrap">
        ...
        <div class="wrap-button">
            ...
            <a target="_blank" href="https://condoy.com/hot-deals-check/?action=1_months" class="button button-success loading">Remove dated properties from Hot Deals Group (1 month)</a>
