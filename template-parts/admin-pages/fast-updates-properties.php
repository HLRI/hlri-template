...
<form action="" method="post">
    <div class="wrap">
        ...
        <div class="wrap-button">
            <a download target="_blank" href="https://condoy.com/just-launched-check/?action=6_months"> class="button button-success loading">Remove dated properties from Just-Launched Group (6 Months)</a>
