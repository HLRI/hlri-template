...
<!--            <a download href="--><?php //= HLR_THEME_URL . "template-parts/admin-pages/backup.json" ?><!--" class="button button-success loading">Download Backup</a>-->
<!---->
<!--        </div>-->
...
//                        ?>
<!--                        <tr>-->
<!--                            <input type="hidden" name="data[--><?php //= get_the_ID() ?><!--][id]" value="--><?php //= get_the_ID() ?><!--">-->
<!--                            <td>--><?php //the_title() ?><!--</td>-->
<!--                            <td><input --><?php //= $meta['opt-project-status'] ? 'checked' : '' ?><!-- type="checkbox" name="data[--><?php //= get_the_ID() ?><!--][opt-project-status]" value="true"></td>-->
<!--                            <td><input type="text" value="--><?php //= $meta['opt-price'] ?><!--" name="data[--><?php //= get_the_ID() ?><!--][opt-price]"></td>-->
<!--                        </tr>-->
<!--                    --><?php
//                    endwhile;
