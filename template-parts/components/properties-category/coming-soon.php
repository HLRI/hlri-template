...
?>
<div id="app">
    <div class="container-fluid mb-5 mt-5" v-show="loading">
        <div class="row">
            <div class="col-12">
                <div class="titr-list">
    ...
    <div class="container-fluid my-5" v-show="showContent">
        <div class="row">
            <div class="col-lg-12">
                <div class="titr-list">
                    <h3 class="font-weight-bold">Coming Soon</h3>
                ...
                <div class="d-flex justify-content-center">
                    <div class="owl-carousel owl-theme listing-wrap wrap-list" v-if="commingsoons.length">
