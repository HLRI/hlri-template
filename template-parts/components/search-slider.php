<div class="wrap-search-slider">
    <div class="search-slider">
        <input autocomplete="off" autocorrect="off"  type="search" id="s" name="s" value="" placeholder="Search condos" autocomplete="off" class="form-control input-search-slider keyword" placeholder="Search by location...">
