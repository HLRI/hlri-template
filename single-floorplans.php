...
?>
    ...
    <div class="container-lg  px-lg-5 my-4">
                ...
                <?php if ($gallery_ids[0]) : ?>
                    <div class="row<?= $loginClasses ?>">
                        <div class="col-12 px-lg-0">
                            ...
                            <div class="col-12 col-md-12 justify-content-center align-items-center p-0<?= $loginClasses ?>"
                                 id="Gallery">
                                        ...
                                        <?php foreach ($gallery_ids as $gallery_item) : ?>
                                            ...
                                            <li class="rounded" data-fancybox="gallery"
                                                ...
                                                <img class="rounded" loading="lazy"
                                                     src="<?= esc_url(wp_get_attachment_url($gallery_item)) ?>"
                    ...
                    <div class="row">
                        <div class="col-12 px-lg-0<?= $loginClasses ?>">
                            <div class="image-floorplan">
                                ...
                                ?>
                                <a href="<?= get_the_post_thumbnail_url() ?>" title="<?= $infoimg ?>"
                                   data-lightbox="roadtrip">
                                    <img loading="lazy" class="img-floorplan" src="<?= get_the_post_thumbnail_url() ?>"
                                         alt="<?= $infoimg ?>">
                                </a>
                            </div>
                        </div>
                    ...
                    <?php if (!empty($floorplans['opt-floorplans-beds']) || !empty($floorplans['opt-floorplans-baths'])) : ?>
                        <div class="col-6 col-lg-3 mb-3 mb-lg-0">
                            <div class="floorplan-item">
                                ...
                                <div class="content-item">
                                    <?= $floorplans['opt-floorplans-beds'] ?>
                                    Bed, <?= $floorplans['opt-floorplans-baths'] ?> Bath
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                        ...
                        <div id="accordion">
                            <div class="">
                                ...
                                <div class="card-header p-0" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link px-0" data-toggle="collapse"
        ...
        <div class="col-lg-3 pl-lg-4 pr-lg-0 px-4" id="register">
            ...
            <div style="background: orange;border-radius: 10px;"><br>
                <h3 class="font-weight-bold h5 mb-0 mt-2 text-center text-white">Register Now to get full package , book
                    your unit</h3>
                    ...
                    <div class="properties-shortcode">
                        <div class="titr-list ml-0 mb-2 pb-1 mr-0">
                            <?php if (isset($mdata_status['opt-project-status'])) : ?>
                                <h3 class="font-weight-bold h5 mb-0 text-center">Fill the Form to get latest available
                                    Listings in This building</h3>
                            <?php else : ?>
                                <h3 class="font-weight-bold h5 mb-0 text-center">Register Now to get full package , book
                                    your unit</h3>
                            <?php endif; ?>
                        </div>
                        <style>
