...
<style>
    ...
    .wpcf7 form.sent .wpcf7-response-output {
        ...
        background: #5dae44;
            ...
            <div style="background: orange;border-radius: 10px;"><br><h3 class="font-weight-bold h5 mb-0 mt-1 text-center text-white">Register Now to get full package , book your unit</h3>
