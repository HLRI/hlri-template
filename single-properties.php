                                        ...
                                        <?php if (array_search('Commercial', $data['opt-type']) === false) : ?>
                                            ...
                                            <li data-label="Baths" class="ic-baths"
                                                ...
                                                <i class="fas fa-bath"></i><br><strong><?php echo($data['opt-min-bath'] != "" ? $data['opt-min-bath'] . " - " : 'TBA '); ?><?php echo $data['opt-max-bath'] ?>
                                                    <?php echo($data['opt-max-half-bath'] != "" ? '<span style="color: #7c7c7c;font-size: 12px;">+ ' . $data['opt-max-half-bath'] . 'Half Bath</span>' : ''); ?>
                                                </strong>
...
<?php if($data['opt-coords']['address'] !== '300 Richmond St W #300, Toronto' && $data['opt-floorplans_walkscore'] !== '0') : ?>
                ...
                <?php if (!empty($psd['price_images'])) : ?>
                    <div class="row mt-5 border-top  mb-4" id="PriceList">
                        ...
                        <?php foreach ($psd['price_images'] as $image) : ?>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-4 <?= $loginClasses ?>">
