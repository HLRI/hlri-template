...
<!--                                        <tr>-->
<!--                                            <td>-->
<!--                                                <div class="d-none">--><?php //= $floor['opt-floorplans-status'] == 'available' ? 'Available' : 'Sold Out' ?><!--</div>-->
<!--                                                <div class="wrap-head-floorplan">-->
<!--                                                    <span class="status-floorplan --><?php //= $floor['opt-floorplans-status'] == 'available' ? 'status-color-success' : 'status-color-danger' ?><!--"></span>-->
<!--                                                    --><?php //the_post_thumbnail('thumbnail', ['loading' => 'lazy']) ?>
<!--                                                </div>-->
<!--                                            </td>-->
<!--                                            <td>--><?php //= $floor['opt-floorplans-suite-name'] ?><!--</td>-->
<!--                                            <td>-->
...
<!--                                                    --><?php //= $floor['opt-floorplans-beds'] . ' Bed' ?><!-- , --><?php //= $floor['opt-floorplans-baths'] . ' Bath' ?>
<!--                                                --><?php //else : ?>
<!--                                                    --><?php //if (!empty($floor['opt-floorplans-baths'])) : ?>
<!--                                                        --><?php //= ', ' . $floor['opt-floorplans-baths'] . ' Bath' ?>
<!--                                                    --><?php //else : ?>
...
<!--                                                    --><?php //= $floor['opt-floorplans-size'] . ' SQFT' ?>
<!--                                                --><?php //else : ?>
<!--                                                    --->
<!--                                                --><?php //endif; ?>
<!--                                            </td>-->
<!--                                            <td>--><?php //= $floor['opt-floorplans-view'] ?><!--</td>-->
<!--                                            <td>-->
<!--                                                --><?php //if (!empty($floor['opt-floorplans-price-from'])) : ?>
<!--                                                    <div class="font-weight-bold">--><?php //= '$' . number_format($floor['opt-floorplans-price-from']) ?><!--</div>-->
<!--                                                --><?php //else : ?>
<!--                                                    --->
<!--                                                --><?php //endif; ?>
<!---->
<!--                                                --><?php //if (!empty($floor['opt-floorplans-price-per'])) : ?>
<!--                                                    <small>--><?php //= '$' . number_format($floor['opt-floorplans-price-per']) . '/sq.ft' ?><!--</small>-->
<!--                                                --><?php //else : ?>
<!--                                                    --->
<!--                                                --><?php //endif; ?>
<!--                                            </td>-->
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table pt-4">
                                    ...
                                    while ($associated_floorplans->have_posts()) :
                                        ...
                                        $floor = get_post_meta(get_the_ID(), 'hlr_framework_floorplans', true);
                                        ?>
                                        <?php $data5 = get_post_meta(get_the_ID(), 'hlr_framework_floorplan_images_gallery', true); print_r($data5) . 'ytrytrytry';
