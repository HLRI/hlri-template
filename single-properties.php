                            ...
                            <?php if (($data['opt-sales-type'] == "Preconstruction") || ($data['opt-sales-type'] == "Resale")) : ?>
                                <div class="characteristics-cnt">
                                    <ul>
                                        ...
                                        <li class="property-type ic-proptype" title="Ownership: <?php echo implode(', ', $data['opt-ownership-type']); ?>" >
                                            <i class="fas fa-fas fa-building"></i><br>
                                            <?php print_r($data['opt-ownership-type']);echo implode(', ', $data['opt-ownership-type']); ?>
                                        </li>
