...
<!--                                                        data-caption="--><?php //= esc_attr($item['caption']) ?><!--"-->
<!--                                                        data-src="--><?php //= esc_url($item['image']) ?><!--"-->
<!--                                                        data-thumb="--><?php //= esc_url($item['thumbnail']) ?><!--">-->
<!--                                                        <img class="rounded" loading="lazy" src="--><?php //= esc_url($item['thumbnail']) ?><!--"-->
<!--                                                             alt="--><?php //= esc_attr($item['caption']) ?><!--">-->
<!--                                                    </li>-->
<!--                                                --><?php //endforeach; ?>
<!--                                            </ul>-->
<!--                                        </div>-->
