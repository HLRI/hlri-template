...
<div class="w-100">
    ...
    <div class="container mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8 ">
                        <div class="card-profile-details px-3 px-md-0">
                            <h1 class="d-inline-block"><?php the_title() ?></h1><span style="font-size: 2.5rem;">,</span><div class="card-profile-details-job-position d-inline-block"><span class=""><?php the_terms(get_the_ID(), 'staff', '', ' / ', ' ') ?></span></div>
        ...
        <div class="card mt-4 pb-3 mb-4">
            ...
            <?php echo do_shortcode('[contact-form-7 id="2f2fdf4" title="Contact Agent" your-subject="fgdfgfdtest"]'); ?>
        </div>
    </div>
</div>
<?php get_footer(); ?>