    ...
    success: function (json) {
      ...
      jQuery.each(list, function (index, item) {
        ...
        var minPrice = post.metadata["opt-min-price"]
            ? '<div class="properties-card_price">' +
            '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line id="secondary-upstroke" x1="16.45" y1="7.5" x2="16.55" y2="7.5"></line><path id="primary" d="M21,10V4a1,1,0,0,0-1-1H14L3.68,13.26a1,1,0,0,0,0,1.41l5.66,5.66a1,1,0,0,0,1.41,0Z"></path></svg>' +
